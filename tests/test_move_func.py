...
def test_remove_func():
    ...
    move = Move(project, from_file, to_file)
    removed_module, function_def = move.remove_function("func")
...
def test_add_func():
    ...
    move = Move(project, from_file, to_file)
    removed_module, function_def = move.remove_function("func")
    added_module = move.add_function("func", function_def)
